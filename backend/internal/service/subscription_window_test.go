...
func (r *subscriptionWindowRepoStub) ResetDailyUsage(_ context.Context, _ int64, start time.Time) error {
	r.dailyStart = &start
	return nil
}

func (r *subscriptionWindowRepoStub) ResetWeeklyUsage(_ context.Context, _ int64, start time.Time) error {
	r.weeklyStart = &start
	return nil
}

func (r *subscriptionWindowRepoStub) ResetMonthlyUsage(_ context.Context, _ int64, start time.Time) error {
