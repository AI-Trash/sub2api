...
func (r *oauthPendingFlowRedeemCodeRepo) DeleteAll(context.Context) (int64, error) {
	panic("unexpected DeleteAll call")
}

func (r *oauthPendingFlowRedeemCodeRepo) DeleteByStatuses(context.Context, []string) (int64, error) {
