...
type channelModelPricingRequest struct {
	...
	ServiceTierMultipliers map[string]float64       `json:"service_tier_multipliers"`
...
func pricingToResponse(p *service.ChannelModelPricing) channelModelPricingResponse {
	...
	return channelModelPricingResponse{
		...
		ServiceTierMultipliers: service.NormalizeServiceTierMultipliers(p.ServiceTierMultipliers),
		Intervals:              intervals,
	}
}
...
func pricingRequestToService(reqs []channelModelPricingRequest) []service.ChannelModelPricing {
	...
	for _, r := range reqs {
		...
		result = append(result, service.ChannelModelPricing{
			...
			ServiceTierMultipliers: service.NormalizeServiceTierMultipliers(r.ServiceTierMultipliers),
			Intervals:              intervals,
		})
	}
	return result
