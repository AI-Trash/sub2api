      ...
      >
        <div class="py-1">
          <template v-if="account">
            ...
            <button @click="$emit('duplicate', account); $emit('close')" class="flex w-full items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-dark-700">
...
const emit = defineEmits(['close', 'test', 'stats', 'duplicate', 'schedule', 'reauth', 'refresh-token', 'recover-state', 'reset-quota', 'set-privacy'])
const { t } = useI18n()
