export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      duplicateSuccess: 'Account duplicated: {name}',
    ...
    redeem: {
      ...
      copyInviteLinks: 'Copy Invite Links',
      inviteLinksCopied: 'Invite links copied',
      copied: 'Copied!',
      download: 'Download',
    ...
    settings: {
      ...
      description: 'Manage registration, email verification, default values, and email service settings',
      tabs: {
        general: 'General',
        agreement: 'Agreement',
      ...
      emailTabDisabledHint: 'Enable email verification in the Security tab to configure the email service.',
      registration: {
      ...
      smtp: {
        ...
        description: 'Configure email sending for verification codes, password resets, and notifications',
        testConnection: 'Test Connection',
        testing: 'Testing...',
        ...
        zeptoMailUrlHint: 'ZeptoMail API URLs can vary by region. Use the full endpoint from your console.',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Enter API Key',
      ...
      testEmail: {
        ...
        description: 'Send a test email to verify your email service configuration',
      ...
      openaiFastPolicy: {
        ...
        description: 'Intercept, filter, pass, or force OpenAI fast(priority) / flex requests based on the request body service_tier field. Applies to the OpenAI gateway only.',
        ...
        tierAll: 'All set tiers',
        tierAny: 'Any, including unset',
        tierNone: 'Unset / unknown',
        ...
        actionSet: 'Force service_tier',
        targetServiceTier: 'Force to',
        targetServiceTierHint: 'Choose priority (fast) to force fast mode. Upstream may still report a different actual service_tier based on account availability.',
        scope: 'Scope',
        scopeAll: 'All accounts',
        scopeOAuth: 'OAuth only',
        scopeAPIKey: 'API Key only',
      ...
      emailConnectionSuccess: 'Email service connection successful',
      smtpConnectionSuccess: 'SMTP connection successful',
      testEmailSent: 'Test email sent successfully',
      failedToLoad: 'Failed to load settings',
      failedToSave: 'Failed to save settings',
      failedToTestEmail: 'Email service connection test failed',
