  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        modelRestrictionDisabledByPassthrough: '已开启自动透传：模型白名单/黑名单/映射不会生效。',
      },
      anthropic: {
    ...
    redeem: {
      ...
      subscription: '订阅',
      invitation: '邀请码',
      invitationHint: '邀请码用于限制用户注册，金额将作为该邀请码注册用户的试用余额，使用后自动标记为已使用。',
      allTypes: '全部类型',
      allStatus: '全部状态',
      unused: '未使用',
      used: '已使用',
      ...
      deleteUsedOrExpired: '删除已使用/已过期',
      deleteAllCodes: '删除全部兑换码',
      deleteCodeConfirm: '确定要删除此兑换码吗？此操作无法撤销。',
      deleteAllUnusedConfirm: '确定要删除全部未使用的兑换码吗？此操作无法撤销。',
      deleteUsedOrExpiredConfirm: '确定要删除全部已使用或已过期的兑换码吗？此操作无法撤销。',
      deleteAllCodesConfirm: '确定要删除所有兑换码吗？此操作无法撤销。',
      deleteAll: '全部删除',
      ...
      copyInviteLinks: '批量复制邀请链接',
      inviteLinksCopied: '邀请链接已全部复制',
      download: '下载',
      codesExported: '兑换码导出成功',
      codeDeleted: '兑换码删除成功',
      codesDeleted: '成功删除 {count} 个未使用的兑换码',
      usedOrExpiredCodesDeleted: '成功删除 {count} 个已使用/已过期的兑换码',
      allCodesDeleted: '成功删除 {count} 个兑换码',
      noUnusedCodes: '没有未使用的兑换码可删除',
      noUsedOrExpiredCodes: '没有已使用或已过期的兑换码可删除',
      noCodesToDelete: '没有兑换码可删除',
      userPrefix: '用户 #{id}',
      failedToExport: '导出兑换码失败',
      failedToDeleteUnused: '删除未使用的兑换码失败',
      failedToDeleteUsedOrExpired: '删除已使用/已过期的兑换码失败',
      failedToDeleteAll: '删除全部兑换码失败',
      failedToCopy: '复制失败',
      selectGroup: '选择分组',
    ...
    settings: {
      title: '系统设置',
      description: '管理注册、邮箱验证、默认值和邮件服务设置',
      tabs: {
        general: '通用设置',
        agreement: '登录条款',
        features: '功能开关',
      ...
      emailTabDisabledHint: '请在「安全与认证」选项卡中启用邮箱验证后，再配置邮件服务。',
      registration: {
        title: '注册设置',
      ...
      smtp: {
        title: '邮件服务设置',
        description: '配置用于发送验证码、重置密码和通知的邮件服务',
        testConnection: '测试连接',
        testing: '测试中...',
        provider: '接入方式',
        providerSmtp: 'SMTP',
        providerBrevo: 'Brevo API',
        providerZeptoMail: 'ZeptoMail API',
        apiUrl: 'API URL',
        apiUrlPlaceholderBrevo: 'https://api.brevo.com/v3/smtp/email',
        apiUrlPlaceholderZeptoMail: 'https://api.zeptomail.com/v1.1/email',
        zeptoMailUrlHint: 'ZeptoMail 不同区域的 API URL 可能不同，可填写控制台提供的完整地址。',
        apiKey: 'API Key',
        apiKeyPlaceholder: '请输入 API Key',
      ...
      openaiFastPolicy: {
        ...
        description: '基于请求体 service_tier 字段拦截、过滤、透传或强制改写 OpenAI fast(priority) 与 flex 请求；仅作用于 OpenAI 网关。',
        ...
        actionBlock: '拦截（拒绝请求）',
        actionSet: '强制设置 service_tier',
        targetServiceTier: '强制设置为',
        targetServiceTierHint: '用于强制 fast 时请选择 priority（fast）。上游仍可能按账号可用性返回实际 service_tier。',
        scope: '生效范围',
        scopeAll: '全部账号',
        scopeOAuth: '仅 OAuth 账号',
        scopeAPIKey: '仅 API Key 账号',
      ...
      emailConnectionSuccess: '邮件服务连接成功',
      smtpConnectionSuccess: 'SMTP 连接成功',
      testEmailSent: '测试邮件发送成功',
      failedToLoad: '加载设置失败',
      failedToSave: '保存设置失败',
      failedToTestEmail: '邮件服务连接测试失败',
